...
-(void)login
{
    ...
    if([res isEqualToString:@"0"])
    {
        ...
        ChooseItemControllerTM *chooseItemControllerTM = [[ChooseItemControllerTM alloc]initWithNibName:@"ChooseItemControllerTM" bundle:nil];
        HistoryViewControllerTM *historyViewControllerTM = [[HistoryViewControllerTM alloc]initWithNibName:@"HistoryViewControllerTM" bundle:nil];
        ChartViewControllerTM *chartViewControllerTM = [[ChartViewControllerTM alloc]initWithNibName:@"ChartViewControllerTM" bundle:nil];
        ...
        UINavigationController *chooseItemNaviController = [[UINavigationController alloc]initWithRootViewController:chooseItemControllerTM];
        [chooseItemNaviController.navigationBar setBackgroundImage:[UIImage imageNamed:@"TM_导航加状态栏"] forBarMetrics:UIBarMetricsDefault];
        [chooseItemNaviController.navigationBar
        ...
        chooseItemNaviController.navigationBar.tintColor = [UIColor whiteColor];
        UINavigationController *historyNaviController = [[UINavigationController alloc]initWithRootViewController:historyViewControllerTM];
        [historyNaviController.navigationBar setBackgroundImage:[UIImage imageNamed:@"TM_导航加状态栏"] forBarMetrics:UIBarMetricsDefault];
        historyNaviController.navigationBar.tintColor = [UIColor whiteColor];
        [historyNaviController.navigationBar
        setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                 [UIColor whiteColor],
                                 UITextAttributeTextColor,[UIColor colorWithRed:0 green:0.7 blue:0.8 alpha:1],
                                 UITextAttributeTextShadowColor,[NSValue valueWithUIOffset:UIOffsetMake(0, 0)],
        ...
        UINavigationController *chartNaviController =  [[UINavigationController alloc]initWithRootViewController:chartViewControllerTM];
        [chartNaviController.navigationBar setBackgroundImage:[UIImage imageNamed:@"TM_导航加状态栏"] forBarMetrics:UIBarMetricsDefault];
        chartNaviController.navigationBar.tintColor = [UIColor whiteColor];
        [chartNaviController.navigationBar
        setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                 [UIColor whiteColor],
                                 UITextAttributeTextColor,[UIColor colorWithRed:0 green:0.7 blue:0.8 alpha:1],
                                 UITextAttributeTextShadowColor,[NSValue valueWithUIOffset:UIOffsetMake(0, 0)],
        ...
        UINavigationController *settingsNaviController = [[UINavigationController alloc]initWithRootViewController:setUserInfoViewController];
        [settingsNaviController.navigationBar setBackgroundImage:[UIImage imageNamed:@"TM_导航加状态栏"] forBarMetrics:UIBarMetricsDefault];
        settingsNaviController.navigationBar.tintColor = [UIColor whiteColor];
        [settingsNaviController.navigationBar
        setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                 [UIColor whiteColor],
                                 UITextAttributeTextColor,[UIColor colorWithRed:0 green:0.7 blue:0.8 alpha:1],
                                 UITextAttributeTextShadowColor,[NSValue valueWithUIOffset:UIOffsetMake(0, 0)],
        ...
        _tabBarController.viewControllers = [NSArray arrayWithObjects:chooseItemNaviController,historyNaviController,chartNaviController, settingsNaviController, nil];
//        [_tabBarController.tabBar setBackgroundImage:[UIImage imageNamed:@"TM_tab_bg"]];
        _tabBarController.tabBar.backgroundColor = [UIColor clearColor];
//        _tabBarController.tabBar.selectionIndicatorImage = [UIImage imageNamed:@"TM_tab_down"];
        
        _tabBarController.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
        //        _tabBarController.modalTransitionStyle = UIModalTransitionStyleCoverVertical;
        //        _tabBarController.modalTransitionStyle = UIModalTransitionStyleFlipHorizontal;
        //        _tabBarController.modalTransitionStyle = UIModalTransitionStylePartialCurl;
